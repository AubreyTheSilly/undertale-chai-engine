...
var tokens = {"+":Token.TokenType.PLUS,"-":Token.TokenType.MINUS,"*":Token.TokenType.STAR,"/":Token.TokenType.SLASH,"!":Token.TokenType.BANG,"=":Token.TokenType.EQUAL,"<":Token.TokenType.LESS,">":Token.TokenType.GREATER,"!=":Token.TokenType.BANG_EQUAL,"==":Token.TokenType.EQUAL_EQUAL,"<=":Token.TokenType.LESS_EQUAL,">=":Token.TokenType.GREATER_EQUAL,"if":Token.TokenType.IF,"else":Token.TokenType.ELSE,"print":Token.TokenType.PRINT,"set":Token.TokenType.SET,"var":Token.TokenType.VAR,"increment":Token.TokenType.INCREMENT,"decrement":Token.TokenType.DECREMENT,"string":Token.TokenType.TYPE_STRING,"bool":Token.TokenType.TYPE_BOOL,"num":Token.TokenType.TYPE_NUM,"break":Token.TokenType.BREAK,"end":Token.TokenType.END,"while":Token.TokenType.WHILE,"playsnd":Token.TokenType.PLAY_SND,"wait":Token.TokenType.WAIT}
