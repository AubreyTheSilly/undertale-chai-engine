...
var MONSTER_CANDY = Item.new("Monster Candy",Item.HEALING,10,["* Monster Candy - Heals 10 HP[wait 2][newline]  Has a distinct, non-licorice[newline]  flavor."],"* You ate the Monster Candy.[wait 2][newline]  Very un-licorice-like.")
