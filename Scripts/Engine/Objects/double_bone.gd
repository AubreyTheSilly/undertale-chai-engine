...
func _draw():
	...
	draw_texture_rect(preload("res://Sprites/Battle/Attacks/bone.png"),Rect2(Vector2(-3,height),Vector2(6.5,-5)),false)
	draw_rect(Rect2(Vector2(-1,0),Vector2(2.5,height)),Color.WHITE)
