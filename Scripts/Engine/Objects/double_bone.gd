...
func _draw():
	if pap:
		...
		draw_texture_rect(preload("res://Sprites/Battle/Attacks/bone_pap.png"),Rect2(Vector2(-2.5,height),Vector2(6.5,-5)),false)
		draw_rect(Rect2(Vector2(-0.5,0),Vector2(2.5,height)),Color.WHITE)
	else:
